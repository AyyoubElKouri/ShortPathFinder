...
interface EmbindModule {
	Algorithm: {
		BFS: AlgorithmValue<0>;
		DIJKSTRA: AlgorithmValue<1>;
		ASTAR: AlgorithmValue<2>;
		IDASTAR: AlgorithmValue<3>;
		DFS: AlgorithmValue<4>;
		JUMPPOINT: AlgorithmValue<5>;
		ORTHOGONALJUMPPOINT: AlgorithmValue<6>;
		TRACE: AlgorithmValue<7>;
	};
	Heuristic: {
		MANHATTAN: HeuristicValue<0>;
		EUCLIDEAN: HeuristicValue<1>;
		OCTILE: HeuristicValue<2>;
		CHEBYSHEV: HeuristicValue<3>;
	};
	VectorUint8: {
		new (): VectorUint8;
	};
