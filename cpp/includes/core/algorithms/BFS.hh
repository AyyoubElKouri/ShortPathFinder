...
/**
 * @brief Breadth-First Search (BFS) algorithm implementation for finding the shortest path in a graph.
 * 
 * This class provides a static method to execute the BFS algorithm on a given graph,
...
class BFS : public IAlgorithm {
  ...
  public:
    /**
     * @brief Find the shortest path from start to goal using the BFS algorithm.
     * 
